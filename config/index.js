export const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: "o7nJg6VSzzxQp97LWVte65hP4vHc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "Q7wWeInKs_iZaveAJPl_hIdAQsuUcYeBegTHZqUs9vQ",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "乐山",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2001", "date": "12-16"},
        {"type": "节日", "name": "相识纪念日", "year": "2021", "date": "03-12"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "你宝宝", "year": "2004", "date": "10-31"}
      ],
  ...
  CALLBACK_TEMPLATE_ID: "B6XBy7tz5x-PYsEosW1CuV11qEBSNnKLm9iCwH9uyIA",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "o7nJg6alhMeofTwMZYq81nAEvDe0",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
